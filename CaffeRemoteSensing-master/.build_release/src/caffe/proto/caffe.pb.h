...
class ImagePairDataParameter;
class CropDataParameter;
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional .caffe.ImagePairDataParameter image_pair_data_param = 150;
  inline bool has_image_pair_data_param() const;
  inline void clear_image_pair_data_param();
  static const int kImagePairDataParamFieldNumber = 150;
  inline const ::caffe::ImagePairDataParameter& image_pair_data_param() const;
  inline ::caffe::ImagePairDataParameter* mutable_image_pair_data_param();
  inline ::caffe::ImagePairDataParameter* release_image_pair_data_param();
  inline void set_allocated_image_pair_data_param(::caffe::ImagePairDataParameter* image_pair_data_param);

  // optional .caffe.CropDataParameter crop_data_param = 151;
  inline bool has_crop_data_param() const;
  inline void clear_crop_data_param();
  static const int kCropDataParamFieldNumber = 151;
  inline const ::caffe::CropDataParameter& crop_data_param() const;
  inline ::caffe::CropDataParameter* mutable_crop_data_param();
  inline ::caffe::CropDataParameter* release_crop_data_param();
  inline void set_allocated_crop_data_param(::caffe::CropDataParameter* crop_data_param);
 ...
 private:
  ...
  inline void set_has_image_pair_data_param();
  inline void clear_has_image_pair_data_param();
  inline void set_has_crop_data_param();
  inline void clear_has_crop_data_param();
  ...
  ::caffe::ImagePairDataParameter* image_pair_data_param_;
  ::caffe::CropDataParameter* crop_data_param_;
  int phase_;
  mutable int _cached_size_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
...
class ImagePairDataParameter : public ::google::protobuf::Message {
 public:
  ImagePairDataParameter();
  virtual ~ImagePairDataParameter();

  ImagePairDataParameter(const ImagePairDataParameter& from);

  inline ImagePairDataParameter& operator=(const ImagePairDataParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const ImagePairDataParameter& default_instance();

  void Swap(ImagePairDataParameter* other);

  // implements Message ----------------------------------------------

  ImagePairDataParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const ImagePairDataParameter& from);
  void MergeFrom(const ImagePairDataParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // optional string image_dir = 1;
  inline bool has_image_dir() const;
  inline void clear_image_dir();
  static const int kImageDirFieldNumber = 1;
  inline const ::std::string& image_dir() const;
  inline void set_image_dir(const ::std::string& value);
  inline void set_image_dir(const char* value);
  inline void set_image_dir(const char* value, size_t size);
  inline ::std::string* mutable_image_dir();
  inline ::std::string* release_image_dir();
  inline void set_allocated_image_dir(::std::string* image_dir);

  // optional string label_dir = 19;
  inline bool has_label_dir() const;
  inline void clear_label_dir();
  static const int kLabelDirFieldNumber = 19;
  inline const ::std::string& label_dir() const;
  inline void set_label_dir(const ::std::string& value);
  inline void set_label_dir(const char* value);
  inline void set_label_dir(const char* value, size_t size);
  inline ::std::string* mutable_label_dir();
  inline ::std::string* release_label_dir();
  inline void set_allocated_label_dir(::std::string* label_dir);
  ...
  // optional uint32 h_img = 9 [default = 0];
  inline bool has_h_img() const;
  inline void clear_h_img();
  static const int kHImgFieldNumber = 9;
  inline ::google::protobuf::uint32 h_img() const;
  inline void set_h_img(::google::protobuf::uint32 value);

  // optional uint32 w_img = 10 [default = 0];
  inline bool has_w_img() const;
  inline void clear_w_img();
  static const int kWImgFieldNumber = 10;
  inline ::google::protobuf::uint32 w_img() const;
  inline void set_w_img(::google::protobuf::uint32 value);

  // optional uint32 h_map = 11 [default = 0];
  inline bool has_h_map() const;
  inline void clear_h_map();
  static const int kHMapFieldNumber = 11;
  inline ::google::protobuf::uint32 h_map() const;
  inline void set_h_map(::google::protobuf::uint32 value);

  // optional uint32 w_map = 12 [default = 0];
  inline bool has_w_map() const;
  inline void clear_w_map();
  static const int kWMapFieldNumber = 12;
  inline ::google::protobuf::uint32 w_map() const;
  inline void set_w_map(::google::protobuf::uint32 value);

  // optional uint32 channels = 13 [default = 3];
  inline bool has_channels() const;
  inline void clear_channels();
  ...
  // optional bool random = 18 [default = true];
  inline bool has_random() const;
  inline void clear_random();
  static const int kRandomFieldNumber = 18;
  ...
  // optional float mean = 3 [default = 0];
  inline bool has_mean() const;
  inline void clear_mean();
  ...
  // optional bool multiclass = 20 [default = false];
  inline bool has_multiclass() const;
  inline void clear_multiclass();
  static const int kMulticlassFieldNumber = 20;
  inline bool multiclass() const;
  inline void set_multiclass(bool value);

  // optional uint32 class_step = 21 [default = 1];
  inline bool has_class_step() const;
  inline void clear_class_step();
  static const int kClassStepFieldNumber = 21;
  inline ::google::protobuf::uint32 class_step() const;
  inline void set_class_step(::google::protobuf::uint32 value);

  // @@protoc_insertion_point(class_scope:caffe.ImagePairDataParameter)
 private:
  inline void set_has_image_dir();
  inline void clear_has_image_dir();
  inline void set_has_label_dir();
  inline void clear_has_label_dir();
  ...
  inline void set_has_h_img();
  inline void clear_has_h_img();
  inline void set_has_w_img();
  inline void clear_has_w_img();
  inline void set_has_h_map();
  inline void clear_has_h_map();
  inline void set_has_w_map();
  inline void clear_has_w_map();
  inline void set_has_channels();
  inline void clear_has_channels();
  ...
  inline void set_has_mean();
  inline void clear_has_mean();
  inline void set_has_multiclass();
  inline void clear_has_multiclass();
  inline void set_has_class_step();
  inline void clear_has_class_step();
  ...
  ::google::protobuf::uint32 h_img_;
  ::google::protobuf::uint32 w_img_;
  ::google::protobuf::uint32 h_map_;
  ::google::protobuf::uint32 w_map_;
  ...
  float scale_;
  float mean_;
  ::google::protobuf::uint32 class_step_;
  friend void  protobuf_AddDesc_caffe_2eproto();
  friend void protobuf_AssignDesc_caffe_2eproto();
  friend void protobuf_ShutdownFile_caffe_2eproto();

  void InitAsDefaultInstance();
  static ImagePairDataParameter* default_instance_;
};
// -------------------------------------------------------------------

class CropDataParameter : public ::google::protobuf::Message {
 public:
  CropDataParameter();
  virtual ~CropDataParameter();

  CropDataParameter(const CropDataParameter& from);

  inline CropDataParameter& operator=(const CropDataParameter& from) {
    CopyFrom(from);
    return *this;
  }
  ...
  static const ::google::protobuf::Descriptor* descriptor();
  static const CropDataParameter& default_instance();

  void Swap(CropDataParameter* other);

  // implements Message ----------------------------------------------

  CropDataParameter* New() const;
  void CopyFrom(const ::google::protobuf::Message& from);
  void MergeFrom(const ::google::protobuf::Message& from);
  void CopyFrom(const CropDataParameter& from);
  void MergeFrom(const CropDataParameter& from);
  void Clear();
  bool IsInitialized() const;
  ...
  // @@protoc_insertion_point(class_scope:caffe.CropDataParameter)
 private:
  ...
  void InitAsDefaultInstance();
  static CropDataParameter* default_instance_;
};
// -------------------------------------------------------------------
...
// optional .caffe.ImagePairDataParameter image_pair_data_param = 150;
inline bool LayerParameter::has_image_pair_data_param() const {
  return (_has_bits_[1] & 0x04000000u) != 0;
}
inline void LayerParameter::set_has_image_pair_data_param() {
  _has_bits_[1] |= 0x04000000u;
}
inline void LayerParameter::clear_has_image_pair_data_param() {
  _has_bits_[1] &= ~0x04000000u;
}
inline void LayerParameter::clear_image_pair_data_param() {
  if (image_pair_data_param_ != NULL) image_pair_data_param_->::caffe::ImagePairDataParameter::Clear();
  clear_has_image_pair_data_param();
}
inline const ::caffe::ImagePairDataParameter& LayerParameter::image_pair_data_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.image_pair_data_param)
  return image_pair_data_param_ != NULL ? *image_pair_data_param_ : *default_instance_->image_pair_data_param_;
}
inline ::caffe::ImagePairDataParameter* LayerParameter::mutable_image_pair_data_param() {
  set_has_image_pair_data_param();
  if (image_pair_data_param_ == NULL) image_pair_data_param_ = new ::caffe::ImagePairDataParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.image_pair_data_param)
  return image_pair_data_param_;
}
inline ::caffe::ImagePairDataParameter* LayerParameter::release_image_pair_data_param() {
  clear_has_image_pair_data_param();
  ::caffe::ImagePairDataParameter* temp = image_pair_data_param_;
  image_pair_data_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_image_pair_data_param(::caffe::ImagePairDataParameter* image_pair_data_param) {
  delete image_pair_data_param_;
  image_pair_data_param_ = image_pair_data_param;
  if (image_pair_data_param) {
    set_has_image_pair_data_param();
  } else {
    clear_has_image_pair_data_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.image_pair_data_param)
}

// optional .caffe.CropDataParameter crop_data_param = 151;
inline bool LayerParameter::has_crop_data_param() const {
  return (_has_bits_[1] & 0x08000000u) != 0;
}
inline void LayerParameter::set_has_crop_data_param() {
  _has_bits_[1] |= 0x08000000u;
}
inline void LayerParameter::clear_has_crop_data_param() {
  _has_bits_[1] &= ~0x08000000u;
}
inline void LayerParameter::clear_crop_data_param() {
  if (crop_data_param_ != NULL) crop_data_param_->::caffe::CropDataParameter::Clear();
  clear_has_crop_data_param();
}
inline const ::caffe::CropDataParameter& LayerParameter::crop_data_param() const {
  // @@protoc_insertion_point(field_get:caffe.LayerParameter.crop_data_param)
  return crop_data_param_ != NULL ? *crop_data_param_ : *default_instance_->crop_data_param_;
}
inline ::caffe::CropDataParameter* LayerParameter::mutable_crop_data_param() {
  set_has_crop_data_param();
  if (crop_data_param_ == NULL) crop_data_param_ = new ::caffe::CropDataParameter;
  // @@protoc_insertion_point(field_mutable:caffe.LayerParameter.crop_data_param)
  return crop_data_param_;
}
inline ::caffe::CropDataParameter* LayerParameter::release_crop_data_param() {
  clear_has_crop_data_param();
  ::caffe::CropDataParameter* temp = crop_data_param_;
  crop_data_param_ = NULL;
  return temp;
}
inline void LayerParameter::set_allocated_crop_data_param(::caffe::CropDataParameter* crop_data_param) {
  delete crop_data_param_;
  crop_data_param_ = crop_data_param;
  if (crop_data_param) {
    set_has_crop_data_param();
  } else {
    clear_has_crop_data_param();
  }
  // @@protoc_insertion_point(field_set_allocated:caffe.LayerParameter.crop_data_param)
}
...
// optional string image_dir = 1;
inline bool ImagePairDataParameter::has_image_dir() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void ImagePairDataParameter::set_has_image_dir() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ImagePairDataParameter::clear_has_image_dir() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void ImagePairDataParameter::clear_image_dir() {
  if (image_dir_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    image_dir_->clear();
  }
  clear_has_image_dir();
}
inline const ::std::string& ImagePairDataParameter::image_dir() const {
  // @@protoc_insertion_point(field_get:caffe.ImagePairDataParameter.image_dir)
  return *image_dir_;
}
inline void ImagePairDataParameter::set_image_dir(const ::std::string& value) {
  set_has_image_dir();
  if (image_dir_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    image_dir_ = new ::std::string;
  }
  image_dir_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.ImagePairDataParameter.image_dir)
}
inline void ImagePairDataParameter::set_image_dir(const char* value) {
  set_has_image_dir();
  if (image_dir_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    image_dir_ = new ::std::string;
  }
  image_dir_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.ImagePairDataParameter.image_dir)
}
inline void ImagePairDataParameter::set_image_dir(const char* value, size_t size) {
  set_has_image_dir();
  if (image_dir_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    image_dir_ = new ::std::string;
  }
  image_dir_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.ImagePairDataParameter.image_dir)
}
inline ::std::string* ImagePairDataParameter::mutable_image_dir() {
  set_has_image_dir();
  if (image_dir_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    image_dir_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:caffe.ImagePairDataParameter.image_dir)
  return image_dir_;
}
inline ::std::string* ImagePairDataParameter::release_image_dir() {
  clear_has_image_dir();
  if (image_dir_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
    ::std::string* temp = image_dir_;
    image_dir_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
inline void ImagePairDataParameter::set_allocated_image_dir(::std::string* image_dir) {
  if (image_dir_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete image_dir_;
  }
  if (image_dir) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.ImagePairDataParameter.image_dir)
}

// optional string label_dir = 19;
inline bool ImagePairDataParameter::has_label_dir() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ImagePairDataParameter::set_has_label_dir() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ImagePairDataParameter::clear_has_label_dir() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ImagePairDataParameter::clear_label_dir() {
  if (label_dir_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    label_dir_->clear();
  }
  clear_has_label_dir();
}
inline const ::std::string& ImagePairDataParameter::label_dir() const {
  // @@protoc_insertion_point(field_get:caffe.ImagePairDataParameter.label_dir)
  return *label_dir_;
}
inline void ImagePairDataParameter::set_label_dir(const ::std::string& value) {
  set_has_label_dir();
  if (label_dir_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    label_dir_ = new ::std::string;
  }
  label_dir_->assign(value);
  // @@protoc_insertion_point(field_set:caffe.ImagePairDataParameter.label_dir)
}
inline void ImagePairDataParameter::set_label_dir(const char* value) {
  set_has_label_dir();
  if (label_dir_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    label_dir_ = new ::std::string;
  }
  label_dir_->assign(value);
  // @@protoc_insertion_point(field_set_char:caffe.ImagePairDataParameter.label_dir)
}
inline void ImagePairDataParameter::set_label_dir(const char* value, size_t size) {
  set_has_label_dir();
  if (label_dir_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    label_dir_ = new ::std::string;
  }
  label_dir_->assign(reinterpret_cast<const char*>(value), size);
  // @@protoc_insertion_point(field_set_pointer:caffe.ImagePairDataParameter.label_dir)
}
inline ::std::string* ImagePairDataParameter::mutable_label_dir() {
  set_has_label_dir();
  if (label_dir_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    label_dir_ = new ::std::string;
  }
  // @@protoc_insertion_point(field_mutable:caffe.ImagePairDataParameter.label_dir)
  return label_dir_;
}
inline ::std::string* ImagePairDataParameter::release_label_dir() {
  clear_has_label_dir();
  if (label_dir_ == &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    return NULL;
  } else {
    ::std::string* temp = label_dir_;
    label_dir_ = const_cast< ::std::string*>(&::google::protobuf::internal::GetEmptyStringAlreadyInited());
    return temp;
  }
}
inline void ImagePairDataParameter::set_allocated_label_dir(::std::string* label_dir) {
  if (label_dir_ != &::google::protobuf::internal::GetEmptyStringAlreadyInited()) {
    delete label_dir_;
  }
  if (label_dir) {
  ...
  // @@protoc_insertion_point(field_set_allocated:caffe.ImagePairDataParameter.label_dir)
}

// optional uint32 batch_size = 4;
inline bool ImagePairDataParameter::has_batch_size() const {
  return (_has_bits_[0] & 0x00000004u) != 0;
}
inline void ImagePairDataParameter::set_has_batch_size() {
  _has_bits_[0] |= 0x00000004u;
}
inline void ImagePairDataParameter::clear_has_batch_size() {
  _has_bits_[0] &= ~0x00000004u;
}
inline void ImagePairDataParameter::clear_batch_size() {
  batch_size_ = 0u;
  clear_has_batch_size();
}
inline ::google::protobuf::uint32 ImagePairDataParameter::batch_size() const {
  // @@protoc_insertion_point(field_get:caffe.ImagePairDataParameter.batch_size)
  return batch_size_;
}
inline void ImagePairDataParameter::set_batch_size(::google::protobuf::uint32 value) {
  set_has_batch_size();
  batch_size_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImagePairDataParameter.batch_size)
}

// optional uint32 rand_skip = 7 [default = 0];
inline bool ImagePairDataParameter::has_rand_skip() const {
  return (_has_bits_[0] & 0x00000008u) != 0;
}
inline void ImagePairDataParameter::set_has_rand_skip() {
  _has_bits_[0] |= 0x00000008u;
}
inline void ImagePairDataParameter::clear_has_rand_skip() {
  _has_bits_[0] &= ~0x00000008u;
}
inline void ImagePairDataParameter::clear_rand_skip() {
  rand_skip_ = 0u;
  clear_has_rand_skip();
}
inline ::google::protobuf::uint32 ImagePairDataParameter::rand_skip() const {
  // @@protoc_insertion_point(field_get:caffe.ImagePairDataParameter.rand_skip)
  return rand_skip_;
}
inline void ImagePairDataParameter::set_rand_skip(::google::protobuf::uint32 value) {
  set_has_rand_skip();
  rand_skip_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImagePairDataParameter.rand_skip)
}

// optional bool shuffle = 8 [default = false];
inline bool ImagePairDataParameter::has_shuffle() const {
  return (_has_bits_[0] & 0x00000010u) != 0;
}
inline void ImagePairDataParameter::set_has_shuffle() {
  _has_bits_[0] |= 0x00000010u;
}
inline void ImagePairDataParameter::clear_has_shuffle() {
  _has_bits_[0] &= ~0x00000010u;
}
inline void ImagePairDataParameter::clear_shuffle() {
  shuffle_ = false;
  clear_has_shuffle();
}
inline bool ImagePairDataParameter::shuffle() const {
  // @@protoc_insertion_point(field_get:caffe.ImagePairDataParameter.shuffle)
  return shuffle_;
}
inline void ImagePairDataParameter::set_shuffle(bool value) {
  set_has_shuffle();
  shuffle_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImagePairDataParameter.shuffle)
}

// optional uint32 h_img = 9 [default = 0];
inline bool ImagePairDataParameter::has_h_img() const {
  return (_has_bits_[0] & 0x00000020u) != 0;
}
inline void ImagePairDataParameter::set_has_h_img() {
  _has_bits_[0] |= 0x00000020u;
}
inline void ImagePairDataParameter::clear_has_h_img() {
  _has_bits_[0] &= ~0x00000020u;
}
inline void ImagePairDataParameter::clear_h_img() {
  h_img_ = 0u;
  clear_has_h_img();
}
inline ::google::protobuf::uint32 ImagePairDataParameter::h_img() const {
  // @@protoc_insertion_point(field_get:caffe.ImagePairDataParameter.h_img)
  return h_img_;
}
inline void ImagePairDataParameter::set_h_img(::google::protobuf::uint32 value) {
  set_has_h_img();
  h_img_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImagePairDataParameter.h_img)
}

// optional uint32 w_img = 10 [default = 0];
inline bool ImagePairDataParameter::has_w_img() const {
  return (_has_bits_[0] & 0x00000040u) != 0;
}
inline void ImagePairDataParameter::set_has_w_img() {
  _has_bits_[0] |= 0x00000040u;
}
inline void ImagePairDataParameter::clear_has_w_img() {
  _has_bits_[0] &= ~0x00000040u;
}
inline void ImagePairDataParameter::clear_w_img() {
  w_img_ = 0u;
  clear_has_w_img();
}
inline ::google::protobuf::uint32 ImagePairDataParameter::w_img() const {
  // @@protoc_insertion_point(field_get:caffe.ImagePairDataParameter.w_img)
  return w_img_;
}
inline void ImagePairDataParameter::set_w_img(::google::protobuf::uint32 value) {
  set_has_w_img();
  w_img_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImagePairDataParameter.w_img)
}

// optional uint32 h_map = 11 [default = 0];
inline bool ImagePairDataParameter::has_h_map() const {
  return (_has_bits_[0] & 0x00000080u) != 0;
}
inline void ImagePairDataParameter::set_has_h_map() {
  _has_bits_[0] |= 0x00000080u;
}
inline void ImagePairDataParameter::clear_has_h_map() {
  _has_bits_[0] &= ~0x00000080u;
}
inline void ImagePairDataParameter::clear_h_map() {
  h_map_ = 0u;
  clear_has_h_map();
}
inline ::google::protobuf::uint32 ImagePairDataParameter::h_map() const {
  // @@protoc_insertion_point(field_get:caffe.ImagePairDataParameter.h_map)
  return h_map_;
}
inline void ImagePairDataParameter::set_h_map(::google::protobuf::uint32 value) {
  set_has_h_map();
  h_map_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImagePairDataParameter.h_map)
}

// optional uint32 w_map = 12 [default = 0];
inline bool ImagePairDataParameter::has_w_map() const {
  return (_has_bits_[0] & 0x00000100u) != 0;
}
inline void ImagePairDataParameter::set_has_w_map() {
  _has_bits_[0] |= 0x00000100u;
}
inline void ImagePairDataParameter::clear_has_w_map() {
  _has_bits_[0] &= ~0x00000100u;
}
inline void ImagePairDataParameter::clear_w_map() {
  w_map_ = 0u;
  clear_has_w_map();
}
inline ::google::protobuf::uint32 ImagePairDataParameter::w_map() const {
  // @@protoc_insertion_point(field_get:caffe.ImagePairDataParameter.w_map)
  return w_map_;
}
inline void ImagePairDataParameter::set_w_map(::google::protobuf::uint32 value) {
  set_has_w_map();
  w_map_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImagePairDataParameter.w_map)
}

// optional uint32 channels = 13 [default = 3];
inline bool ImagePairDataParameter::has_channels() const {
  return (_has_bits_[0] & 0x00000200u) != 0;
}
inline void ImagePairDataParameter::set_has_channels() {
  _has_bits_[0] |= 0x00000200u;
}
inline void ImagePairDataParameter::clear_has_channels() {
  _has_bits_[0] &= ~0x00000200u;
}
inline void ImagePairDataParameter::clear_channels() {
  channels_ = 3u;
  clear_has_channels();
}
inline ::google::protobuf::uint32 ImagePairDataParameter::channels() const {
  // @@protoc_insertion_point(field_get:caffe.ImagePairDataParameter.channels)
  return channels_;
}
inline void ImagePairDataParameter::set_channels(::google::protobuf::uint32 value) {
  set_has_channels();
  channels_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImagePairDataParameter.channels)
}

// optional bool random = 18 [default = true];
inline bool ImagePairDataParameter::has_random() const {
  return (_has_bits_[0] & 0x00000400u) != 0;
}
inline void ImagePairDataParameter::set_has_random() {
  _has_bits_[0] |= 0x00000400u;
}
inline void ImagePairDataParameter::clear_has_random() {
  _has_bits_[0] &= ~0x00000400u;
}
inline void ImagePairDataParameter::clear_random() {
  random_ = true;
  clear_has_random();
}
inline bool ImagePairDataParameter::random() const {
  // @@protoc_insertion_point(field_get:caffe.ImagePairDataParameter.random)
  return random_;
}
inline void ImagePairDataParameter::set_random(bool value) {
  set_has_random();
  random_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImagePairDataParameter.random)
}

// optional float scale = 2 [default = 1];
inline bool ImagePairDataParameter::has_scale() const {
  return (_has_bits_[0] & 0x00000800u) != 0;
}
inline void ImagePairDataParameter::set_has_scale() {
  _has_bits_[0] |= 0x00000800u;
}
inline void ImagePairDataParameter::clear_has_scale() {
  _has_bits_[0] &= ~0x00000800u;
}
inline void ImagePairDataParameter::clear_scale() {
  scale_ = 1;
  clear_has_scale();
}
inline float ImagePairDataParameter::scale() const {
  // @@protoc_insertion_point(field_get:caffe.ImagePairDataParameter.scale)
  return scale_;
}
inline void ImagePairDataParameter::set_scale(float value) {
  set_has_scale();
  scale_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImagePairDataParameter.scale)
}

// optional float mean = 3 [default = 0];
inline bool ImagePairDataParameter::has_mean() const {
  return (_has_bits_[0] & 0x00001000u) != 0;
}
inline void ImagePairDataParameter::set_has_mean() {
  _has_bits_[0] |= 0x00001000u;
}
inline void ImagePairDataParameter::clear_has_mean() {
  _has_bits_[0] &= ~0x00001000u;
}
inline void ImagePairDataParameter::clear_mean() {
  mean_ = 0;
  clear_has_mean();
}
inline float ImagePairDataParameter::mean() const {
  // @@protoc_insertion_point(field_get:caffe.ImagePairDataParameter.mean)
  return mean_;
}
inline void ImagePairDataParameter::set_mean(float value) {
  set_has_mean();
  mean_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImagePairDataParameter.mean)
}

// optional bool multiclass = 20 [default = false];
inline bool ImagePairDataParameter::has_multiclass() const {
  return (_has_bits_[0] & 0x00002000u) != 0;
}
inline void ImagePairDataParameter::set_has_multiclass() {
  _has_bits_[0] |= 0x00002000u;
}
inline void ImagePairDataParameter::clear_has_multiclass() {
  _has_bits_[0] &= ~0x00002000u;
}
inline void ImagePairDataParameter::clear_multiclass() {
  multiclass_ = false;
  clear_has_multiclass();
}
inline bool ImagePairDataParameter::multiclass() const {
  // @@protoc_insertion_point(field_get:caffe.ImagePairDataParameter.multiclass)
  return multiclass_;
}
inline void ImagePairDataParameter::set_multiclass(bool value) {
  set_has_multiclass();
  multiclass_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImagePairDataParameter.multiclass)
}

// optional uint32 class_step = 21 [default = 1];
inline bool ImagePairDataParameter::has_class_step() const {
  return (_has_bits_[0] & 0x00004000u) != 0;
}
inline void ImagePairDataParameter::set_has_class_step() {
  _has_bits_[0] |= 0x00004000u;
}
inline void ImagePairDataParameter::clear_has_class_step() {
  _has_bits_[0] &= ~0x00004000u;
}
inline void ImagePairDataParameter::clear_class_step() {
  class_step_ = 1u;
  clear_has_class_step();
}
inline ::google::protobuf::uint32 ImagePairDataParameter::class_step() const {
  // @@protoc_insertion_point(field_get:caffe.ImagePairDataParameter.class_step)
  return class_step_;
}
inline void ImagePairDataParameter::set_class_step(::google::protobuf::uint32 value) {
  set_has_class_step();
  class_step_ = value;
  // @@protoc_insertion_point(field_set:caffe.ImagePairDataParameter.class_step)
}
...
// optional int32 h = 1;
inline bool CropDataParameter::has_h() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void CropDataParameter::set_has_h() {
  _has_bits_[0] |= 0x00000001u;
}
inline void CropDataParameter::clear_has_h() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void CropDataParameter::clear_h() {
  h_ = 0;
  clear_has_h();
}
inline ::google::protobuf::int32 CropDataParameter::h() const {
  // @@protoc_insertion_point(field_get:caffe.CropDataParameter.h)
  return h_;
}
inline void CropDataParameter::set_h(::google::protobuf::int32 value) {
  set_has_h();
  h_ = value;
  // @@protoc_insertion_point(field_set:caffe.CropDataParameter.h)
}

// optional int32 w = 2;
inline bool CropDataParameter::has_w() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void CropDataParameter::set_has_w() {
  _has_bits_[0] |= 0x00000002u;
}
inline void CropDataParameter::clear_has_w() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void CropDataParameter::clear_w() {
  w_ = 0;
  clear_has_w();
}
inline ::google::protobuf::int32 CropDataParameter::w() const {
  // @@protoc_insertion_point(field_get:caffe.CropDataParameter.w)
  return w_;
}
inline void CropDataParameter::set_w(::google::protobuf::int32 value) {
  set_has_w();
  w_ = value;
  // @@protoc_insertion_point(field_set:caffe.CropDataParameter.w)
}
